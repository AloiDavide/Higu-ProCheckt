...
image bus = im.Scale("bg/bus stop.png", 1920, 1080)
...
image small_shrine = im.Scale("bg/small shrine.png", 1920, 1080)
image road = im.Scale("bg/road.png", 1920, 1080)
image road2 = im.Scale("bg/road2.png", 1920, 1080)
image police = im.Scale("bg/police.png", 1920, 1080)
image police2 = im.Scale("bg/police interior.png", 1920, 1080)
image okonomiya = im.Scale("bg/okonomiya.png", 1920, 1080)
image field = im.Scale("bg/field.png", 1920, 1080)
image dam = im.Scale("bg/dam.png", 1920, 1080)
image car_city = im.Scale("bg/car city.png", 1920, 1080)
...
image judge_stand = im.Scale("bg/judge stand.jpg", 1920, 1080)
image witness_stand = im.Scale("bg/witness stand.png", 1920, 1080)
image rikacg = im.Scale("bg/rikacg.png", 1920, 1080)
image sonozroom = im.Scale("bg/sonozroom.png", 1920, 1080)
image airport = im.Scale("bg/airport.png", 1920, 1080)
