...
define config.name = _("Welcome to Hinamizawa")
...
define build.name = "WelcomeToHinamizawa"
...
define config.main_menu_music = "audio/over the sky.mp3"
...
define config.save_directory = "bk-1661783498"
